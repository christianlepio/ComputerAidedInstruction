			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
                        ...
                        <?php
                            if(isset($_GET['error'])){
                                if($_GET['error'] == "emptyfields"){
                                    ...
                                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong><i class="fa-solid fa-circle-exclamation"></i></strong> &nbsp;Incorrect username, please try again.
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>';
                                    ...
                                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong><i class="fa-solid fa-circle-exclamation"></i></strong> &nbsp;Incorrect Email, please try again.
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>';
                                    ...
                                    echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <strong><i class="fa-solid fa-circle-exclamation"></i></strong> &nbsp;Unknown username, please try again.
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>';
			      	...
			      	<div class="d-flex">
			      		...
			      		<div class="form-group mb-3">
                              <div class="row justify-content-center">
                                  <div class="col-md mb-3">
                                        <input type="text" name="lrn" class="form-control" placeholder="Username" required>
                                  </div>
                                  <div class="col-md">
                        ...
                        <div class="form-group mb-3">
                              <div class="row justify-content-center">
                                  ...
                                  <div class="col-md">
                                        <input type="text" name="contact" class="form-control" placeholder="Email" required>
                                  </div>
                              </div>
			      		</div>
		                <div class="form-group mb-3">
		            ...
		            <div class="form-group">
		            	<button type="submit" name="forg2-submit" class="form-control btn btn-primary rounded submit px-3">Save</button>
		            </div>
						<div class="text-center">
							<a href="loguser.php"><--Back</a>
						</div>
		          </form>
		        </div>
		      </div>
